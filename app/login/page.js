  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      ...
      <div className="flex flex-col md:flex-row bg-white shadow-xl rounded-lg overflow-hidden w-full max-w-3xl">
        ...
        <div className="md:w-1/2 w-full bg-gradient-to-br from-[#CC2B2B] to-[#FFA500] flex items-center justify-center py-10 md:py-0">
          <h2 className="text-white text-3xl font-bold animate-pulse">Welcome Back!</h2>
        </div>

        {/* Right Side (Login Form) */}
        <div className="md:w-1/2 w-full p-8 flex flex-col justify-center">
          <h2 className="text-3xl text-center text-[#1e40af] font-semibold mb-6">Login</h2>
