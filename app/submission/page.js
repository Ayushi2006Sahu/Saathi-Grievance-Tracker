...
const SubmissionForm = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 px-4 sm:px-6 lg:px-8">
      {/* Main Container */}
      <div className="w-full max-w-lg bg-white shadow-xl rounded-xl p-6 transform transition-all duration-500 hover:scale-105 animate-slide-in border-t-4 border-[#6AC47E]">
        {/* Title */}
        <h2 className="text-3xl font-semibold text-center text-[#2F855A] mb-4">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-[#6AC47E] hover:bg-[#56a76b] text-white font-medium py-3 rounded-md transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg"
          >
            Submit Grievance
          </button>
        </form>
